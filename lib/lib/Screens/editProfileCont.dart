...
import 'package:inst_trial/Screens/profile.dart';
import 'package:inst_trial/Screens/profileCont.dart';
import 'package:inst_trial/Screens/wraper.dart';
import 'package:inst_trial/components/social_icon.dart';
...
class editProfileCon extends StatefulWidget {
  ...
  @override
  _editProfileCon createState() => _editProfileCon();

}

class _editProfileCon extends State<editProfileCon> {
...
return Scaffold(
  ...
  leading: IconButton(
    ...
    onPressed: (){Navigator.of(context).push(
              MaterialPageRoute(builder: (context)=>profileCont(),));        
