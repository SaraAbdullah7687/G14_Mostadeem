...
import 'package:mostadeem/screens/home/forgotPass.dart';
...
class _changePass extends State<changePass> {
  ...
  Widget buildPassword() => TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffix: InkWell(
            ...
            child:
                Icon(Icons.visibility, color: Color.fromRGBO(48, 126, 80, 1)),
          ),
          prefixIcon: Padding(
            padding: EdgeInsets.all(0.0),
            child: Icon(Icons.lock, color: Color.fromRGBO(48, 126, 80, 1)),
          ),
          ...
          focusedBorder: OutlineInputBorder(
            borderSide: const BorderSide(
                color: Color.fromRGBO(48, 126, 80, 1), width: 2.0),
            borderRadius: BorderRadius.circular(15.0),
          ),
        ),
  ...
  Widget buildNewPassword() => Column(children: [
        Container(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Padding(
                  padding: EdgeInsets.all(0.0),
                  child:
                      Icon(Icons.lock, color: Color.fromRGBO(48, 126, 80, 1)),
                ),
                ...
                focusedBorder: OutlineInputBorder(
                  borderSide:
                      const BorderSide(color: Color.fromRGBO(48, 126, 80, 1)),
                  borderRadius: BorderRadius.circular(15.0),
                ),
              ),
              controller: _newPass,
  ...
  Widget buildNext() => ElevatedButton(
      ...
      onPressed: () async {
        if (formKey.currentState.validate()) if (pass == true) {
          try {
            ...
            if (newPassword == confirmPass) {
              if (newPassword == password) {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AdvanceCustomAlert(
                          icon: Icons.password,
                          msgTitle: 'Passwords are the same\n',
                          msgContent:
              ...
              showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AdvanceCustomAlert(
                        icon: Icons.cancel_outlined,
                        msgTitle: 'Passwords does not match\n',
                        msgContent:
          ...
          showDialog(
              ...
              builder: (BuildContext context) {
                return AdvanceCustomAlert(
                  ...
                  msgContent:
                      'Please follow the given criteria for the new password',
                  btnContent: 'Ok',
                );
              });
        }
