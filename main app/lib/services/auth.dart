...
class AuthService {
  ...
  Stream<UserMu> get user {
    return _auth.authStateChanges().map(
        _userFromFirebaseUser); // was onAuthStateChanged instead of authStateChanges()
  ...
  String updateInstitutionStatus(String status, String uid) {
    // return string ?
...
return "user type is problem";*/
  ...
  String updateAppointmentStatus(String status, String appointmentID) {
    // return string ?

    String institutionID = getCurrentUserID();
    String result = DatabaseService()
        .updateAppointment(appointmentID, status, institutionID);
    return result;
  }

  Future<String> updateRequestStatus(
      String status, String contID, String reqID) async {
    // return string ?
    String institutionID = getCurrentUserID();
    String result = await DatabaseService()
        .updateRequest(contID, status, reqID, institutionID);
    return result;
  }
  ...
  addStore(String name, String ig) {
