...
// rating===============================================================================================================
  ...
  Future<void> Rating(DocumentSnapshot request) async {
    ...
    if (request['status'] == 'done' &&
        request['isRated'].toString() == 'false') {
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: [
            ...
            //###################################### 'canceled' status in sprint 4 sara
        ...
        Row(
          ...
          children: [
            ...
            if (document['status'] == 'done' &&
                document['isRated'].toString() == 'true') // I change it
              Container(
                margin: const EdgeInsets.only(right: 25, bottom: 10, top: 5),
                child: SizedBox(
                  height: 30,
                  width: 100,
        ...
        body: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              if (snapshot.data.docs.length == 0) {
                return Center(
                  child: Text(
                    "You don't have history requests",
                    style: TextStyle(
                      fontSize: 18,
                      color: Colors.grey,
                    ),
