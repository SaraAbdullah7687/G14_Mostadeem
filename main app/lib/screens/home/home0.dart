...
/*information*/
  ...
  getInfo() async {
    ...
    for (var infoSnapshot in _allResults) {
      ...
      var title = Information.fromSnapshot(infoSnapshot).title;
                        ...
                        children: <Widget>[
                          DefaultTextStyle(
                            ...
                            child: AnimatedTextKit(
                                ...
                                animatedTexts: [
                                  TyperAnimatedText(desList[counter],
                                      speed: Duration(milliseconds: 100)),
                                  TyperAnimatedText(desList[counter - 1],
                                      speed: Duration(milliseconds: 100)),
                                  TyperAnimatedText(desList[counter - 2],
                                      speed: Duration(milliseconds: 100)),
                                ]),
                          ),
                        ]),
                  ...
                  TyperAnimatedText(_allResults.length.toString())
                    ...
                    children: [
                      DefaultTextStyle(
                        ...
                        child: AnimatedTextKit(
                          pause: Duration(microseconds: 4000000),
                          animatedTexts: [
                            TyperAnimatedText(desList[0]),
                            TyperAnimatedText(desList[1]),
                          ],
    ...
    for (var i = 0; i < _allResults.length; i++) {
      return DefaultTextStyle(
        ...
        child: AnimatedTextKit(
          pause: Duration(microseconds: 4000000),
          animatedTexts: [
            TyperAnimatedText(desList[i], speed: Duration(milliseconds: 5000))
          ],
          repeatForever: true,
        ),
      );
  ...
  displayTitle() {
    for (var i = 0; i < _allResults.length; i++) {
      return DefaultTextStyle(
        ...
        child: AnimatedTextKit(
          isRepeatingAnimation: true,
          pause: const Duration(microseconds: 4000000),
          animatedTexts: [
            TyperAnimatedText(titList[i]),
          ],
        ),
      );
    }
