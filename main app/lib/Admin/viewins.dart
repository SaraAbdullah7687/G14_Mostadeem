...
//),//),
  ...
  sendEmailByMailer(
      String uid, BuildContext context, DocumentSnapshot document) async {
            ...
            press: () {
              if (status == "approve") {
                ...
                if (result == 'Success approve') {
                  ...
                  showTopSnackBar(context, 'Success',
                      'Institution has been approved', Icons.add_task);
                } else if (result == 'Fail approve') {
                  print('could not update status, procces failed');
                  showTopSnackBar(
                    context,
                ...
                if (result == 'Success disapprove') {
                  // show another pop up
                  print('intitution has been deleted'); // may change it
                  sendEmailByMailer("disapproveEmail", context, document);
                  showTopSnackBar(context, 'Success',
                      'Institution has been disapproved', Icons.add_task);
                } else if (result == 'Fail disapprove') {
                  print('could not delete institution, procces failed');
                  showTopSnackBar(
                    context,
