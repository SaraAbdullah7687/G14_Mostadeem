...
import 'package:inst_app/components/twoButtonsAlert.dart';
import 'package:intl/intl.dart';
import 'package:inst_app/components/customAlert.dart';
...
class ViewRequestViewModel with ChangeNotifier {
  ...
  fetchRequestsHistory() async {
    ...
    var firebase=  FirebaseFirestore.instance
        ...
        .collection("appointment");
    _requestsHistory =
        firebase.where("status", isEqualTo: "done").where("date", isGreaterThanOrEqualTo: dateFormat.format(DateTime.now()), ).orderBy("date").snapshots(); // order by  + exclude old dates
    notifyListeners();
  }
